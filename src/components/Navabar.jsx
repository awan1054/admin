...
const Navabar = () => {
  ...
  <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
    ...
    */}
      ...
      <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <img className="h-10 w-auto rounded-full" src={sahayatri} alt="SAHAYATRI" />
  ...
  <div className="sm:hidden" id="mobile-menu">
    <div className="space-y-1 px-2 pb-3 pt-2">
      ...
      <Link to="/bike" className="block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Bike details</Link>
